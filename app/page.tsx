...
<div className="space-y-12">
  ...
  <div className="flex flex-col space-y-4">
    {[
      ...
      { title: "Auto Insurance Pricing Modeling", stack: "Python / GLM", desc: "Developed a two-part actuarial pricing model using French motor claims data. ", tags: ["GLM", "Actuarial"], link: "https://github.com/shahbazayaz/auto-insurance-pricing-freMTPL2freq/tree/main", type: "code" },
